...
const Filter = (props: any) => {
    ...
    const fetchData = async (type: string) => {
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..CATp66oj3XhYAVev7bd_3vN3cAMtUt7sBeduDPC9n3Y';
