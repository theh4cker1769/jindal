...
const Filter = (props: any) => {
    ...
    const fetchData = async (type: string) => {
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..xACukZkv4hMV1MWZz9Bpwpq5v8aXe6HntUGa_eObyO0';
