...
const Filter = (props: any) => {
    ...
    const fetchData = async (type: string) => {
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zhWKC602RmYVijMn6LkDltN45btCqsYmWmLV0AA6gO4';
