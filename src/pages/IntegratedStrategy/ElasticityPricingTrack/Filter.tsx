...
const Filter = (props: any) => {
    ...
    //         const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..aJ89CajoO8rC8uNaWmIR0tRH4ySO9zo8p3SZlXug9AI';
    //         const url = 'https://client3.wisdomanalytics.com/server/api/filter/elasticityProducts';
    //         const payload = {
    //             "country": "AUSTRALIA",
    //             "category": null,
    //             "segment": null,
    ...
    //             "dataSource": "sellOut",
    //             "geoLevel": ["4A-RTLR"],
    //             "channel": ["GROCERY", "PHARMACY"],
    //             "geoLevel2": ["4A-RTLR-CHEMIST_WHS"]
    //         }
    ...
    const productFilters = {
        category: [
            ...
            { value: 'NAPPIES & CHILD CARE', label: 'NAPPIES & CHILD CARE' }
        ],
        ...
        segment: [
            ...
            { value: 'NAPPY PANTS-UNMAPPED', label: 'NAPPY PANTS-UNMAPPED' },
        ...
        subBrand: [
            ...
            { value: 'HUGGIES ULTIMATE', label: 'HUGGIES ULTIMATE' },
        ...
        packSize: [
            ...
            { value: 'BULK PK-WALKER NAP', label: 'BULK PK-WALKER NAP' },
            ...
            { value: 'JUMBO PK-JUNIOR NAP', label: 'JUMBO PK-JUNIOR NAP' },
    ...
    const handleChangeProduct = (selectedValues: any) => {
        setProductLoad(selectedValues)
    }

    const applyFilter = () => {
        props.sendProductData(productLoad)
    }
                    ...
                    <>
                        ...
                        <li>
                            <Select
                                ...
                                classNamePrefix="select"
                                isSearchable={true}
                                options={productFilters.segment}
                        ...
                        <li>
                            <Select
                                ...
                                classNamePrefix="select"
                                isSearchable={true}
                                options={productFilters.subBrand}
                        ...
                        <li>
                            <Select
                                ...
                                classNamePrefix="select"
                                isSearchable={true}
                                options={productFilters.packSize}
                        ...
                        <li>
                            <Select
                                ...
                                classNamePrefix="select"
                                isSearchable={true}
                                options={productFilters.permutation}
